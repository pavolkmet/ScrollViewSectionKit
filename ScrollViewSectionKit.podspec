#
#  Be sure to run `pod spec lint ScrollViewSectionKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage  = "https://github.com/pavolkmet/ScrollViewSectionKit"
  ...
  spec.source = { :git => "https://github.com/pavolkmet/ScrollViewSectionKit.git", :tag => "#{spec.version}" }
  ...
  spec.resource_bundles = {
    'ScrollViewSectionKit' => ['Sources/**/PrivacyInfo.xcprivacy']
  }
